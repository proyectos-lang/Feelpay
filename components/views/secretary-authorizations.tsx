...
export function SecretaryAuthorizations() {
  ...
  const fetchApprovedTransactions = async () => {
    try {
      ...
      // `usuarios`. Esta pantalla lo resolvia contra `admin`, una tabla con
      // UNA sola fila ("Luisa Secretaria"), asi que todos los movimientos
      // aparecian a nombre de esa misma persona sin importar quien los
      // hubiera registrado.
      //
